                                ...
                                <div class="col-sm-6 offset-sm-3 text-center slider-text">
                                    <div class="slider-text-inner">
                                        <div class="desc">
                                            ...
                                            <p><a href="/product" class="btn btn-primary">Shop Collection</a></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-3 mb-4 text-center">
                        <!-- <div class="product-entry border">
                            <a href="#" class="prod-img">
                                <img src="/client/images/banner/item-1.jpg" class="img-fluid"
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col partner-col text-center">
                        <img src="/client/img/banner/brand-1.jpg" class="img-fluid"
                            alt="Free html4 bootstrap 4 template">
                    </div>
                    <div class="col partner-col text-center">
                        <img src="/client/img/banner/brand-2.jpg" class="img-fluid"
                            alt="Free html4 bootstrap 4 template">
                    </div>
                    <div class="col partner-col text-center">
                        <img src="/client/img/banner/brand-3.jpg" class="img-fluid"
                            alt="Free html4 bootstrap 4 template">
                    </div>
                    <div class="col partner-col text-center">
                        <img src="/client/img/banner/brand-4.jpg" class="img-fluid"
                            alt="Free html4 bootstrap 4 template">
                    </div>
                    <div class="col partner-col text-center">
                        <img src="/client/img/banner/brand-5.jpg" class="img-fluid"
                            alt="Free html4 bootstrap 4 template">
                    </div>
                </div>
            </div>
