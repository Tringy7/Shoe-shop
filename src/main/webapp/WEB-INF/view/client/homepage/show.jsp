                                            ...
                                            <div class="col-sm-6 offset-sm-3 text-center slider-text">
                                                <div class="slider-text-inner">
                                                    <div class="desc">
                                                        ...
                                                        <p><a href="/product" class="btn btn-primary">Shop
                                                                Collection</a>
                                                        </p>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-sm-6 offset-sm-3 text-center slider-text">
                                                <div class="slider-text-inner">
                                                    <div class="desc">
                                                        ...
                                                        <h2 class="head-3"><strong class="font-weight-bold">50%</strong>
                                                            Off
                                                        </h2>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-sm-12 text-center">
                                    <h2 class="intro">It started with a simple idea: Create quality, well-designed
                                        products
                                        that
                                        I
                                        wanted myself.</h2>
