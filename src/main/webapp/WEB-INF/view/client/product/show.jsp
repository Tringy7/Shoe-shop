            ...
            <div id="page">
                ...
                <div class="breadcrumbs">
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                <p class="bread"><span><a href="/homepage">Home</a></span> / <span>Products</span></p>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="side border mb-1">
                                            ...
                                            <ul id="CheckBrand">
                                                ...
                                                <li>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" value="Merrel"
                                                            id="brandMerrel">
                                                        <label class="form-check-label" for="brandMerrel">Merrel</label>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" value="Gucci"
                                                            id="brandGucci">
                                                        <label class="form-check-label" for="brandGucci">Gucci</label>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" value="Skechers"
                                                            id="brandSkechers">
                                                        <label class="form-check-label" for="brandSkechers">Puma</label>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="side border mb-1">
                                            ...
                                            <ul id="CheckColor">
                                                ...
                                                <li>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" value="Cream"
                                                            id="colorCream">
