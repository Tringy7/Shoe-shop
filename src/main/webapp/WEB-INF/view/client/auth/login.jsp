...
<body class="m-0 font-sans antialiased font-normal bg-white text-start text-base leading-default text-slate-500">
  ...
  <nav
    ...
    <div class="container flex items-center justify-between py-0 flex-wrap-inherit">
      <a class="py-1.75 ml-4 mr-4 font-bold text-white text-sm whitespace-nowrap lg:ml-0" href="/" target="_blank">
        Shoeshop </a>
      ...
      <a class="py-1.75 ml-4 mr-4 font-bold text-white text-sm whitespace-nowrap lg:ml-0" href="about" target="_blank">
        About </a>
    </div>
  </nav>
                ...
                <form role="form text-left" action="/login" method="POST">
                  <div class="mb-4">
                    <input type="email"
                      ...
                      placeholder="Email" aria-label="Email" aria-describedby="email-addon" name="username" type="email"
                      id="username" />
                  </div>
                  <div class="mb-4">
                    <input type="password"
                      class="placeholder:text-gray-500 text-sm focus:shadow-primary-outline leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-blue-500 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow"
                      placeholder="Password" aria-label="Password" aria-describedby="password-addon" id="inputPassword"
                  ...
                  <div class="min-h-6 pl-7 mb-0.5 block">
                    ...
                    <label class="mb-2 ml-1 font-normal cursor-pointer text-sm text-slate-700" for="flexCheckDefault"><a
                        href="javascript:;" class="font-bold text-slate-700">Remember me</a>
                    </label>
                  </div>
                  ...
                  <p class="mt-4 mb-0 leading-normal text-sm">Don't have an account? <a href="/register"
                      class="font-bold text-slate-700">Sign up</a></p>
                </form>
              </div>
            </div>
          </div>
